...
const questions = parseQuestions('тест С++.txt');
const outputContent = `// Parsed ${questions.length} questions for C++\nconst cppQuestions = ${JSON.stringify(questions, null, 2)};\n`;

fs.writeFileSync('cpp_questions.js', outputContent, 'utf8');
